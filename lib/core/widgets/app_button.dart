...
import 'package:kars_driver_app/gen/fonts.gen.dart' show FontFamily;
...
class AppButton extends StatelessWidget {
  ...
  const AppButton.outlined({
    ...
    this.leadingIcon,
    this.borderRadius,
    this.textColor = ColorName.atenoBlue,
    this.isLoading = false,
    this.isWidthDynamic = false,
    this.borderColor = ColorName.romanSilver,
  ...
  Color get defaultTextColor {
    switch (type) {
      ...
      case AppButtonType.outlined:
        return onTap == null ? ColorName.atenoBlue : textColor;
        ...
        final style = _themeStyle(context)?.copyWith(
          ...
          backgroundColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.disabled)) {
              return ColorName.atenoBlue50;
            }

            return backgroundColor ?? ColorName.atenoBlue;
          }),
        );
        ...
        final style = _themeStyle(context)?.copyWith(
          ...
          side: borderColor != null
              ? WidgetStateProperty.all(
                  BorderSide(color: borderColor ?? ColorName.quickSilver),
                )
              : null,
          shape: WidgetStateProperty.all<RoundedRectangleBorder>(
            RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(borderRadius ?? 8),
              side: BorderSide(
                color: borderColor ?? ColorName.atenoBlue,
              ),
            ),
          ),
